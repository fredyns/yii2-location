...
CREATE TABLE IF NOT EXISTS `rgn_area` (
...
CREATE TABLE IF NOT EXISTS `rgn_area_lang` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `rgn_type` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `recordStatus` ENUM('active', 'deleted') NOT NULL DEFAULT 'active',
  `created_at` INT(10) UNSIGNED NULL DEFAULT NULL,
  `created_by` INT(10) UNSIGNED NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `rgn_type_lang` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `rgn_partCount` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `part_of` INT(10) UNSIGNED NULL DEFAULT NULL,
  `type_id` INT(10) UNSIGNED NOT NULL,
...
CREATE TABLE IF NOT EXISTS `rgn_postcode` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
