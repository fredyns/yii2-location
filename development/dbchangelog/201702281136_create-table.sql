...
CREATE TABLE IF NOT EXISTS `locationName_lang` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `locationType_lang` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `locationNodeCount` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `parent_id` INT(10) UNSIGNED NULL DEFAULT NULL,
  `locationType_id` INT(10) UNSIGNED NOT NULL,
...
CREATE TABLE IF NOT EXISTS `locationPostcode` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
